...
while loop1:     
    ...
    sort_description = {bubble_sort: "Bubble Sort (or Sinking Sort) is the simplest sorting algorithm. It traverses through a list, swapping adjacent elements if they are in the wrong order. It has a Big \'O\' complexity of O(n^2)", 
